...
echo [3/5] Installation de Jarvis et des dependances...
".venv\Scripts\python.exe" -m pip install -e ".[dev]"
if errorlevel 1 goto :error

if not exist ".env" (
    echo [4/5] Creation de la configuration locale...
    copy /Y ".env.example" ".env" >nul
) else (
    echo [4/5] Configuration locale deja presente.
)

echo [5/5] Preparation du pont Thunderbird...
