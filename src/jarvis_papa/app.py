...
<body>
  <main>
    <section class="card">
      ...
      <h1>Bonjour 👋</h1>
      <p>Le cœur local de Jarvis fonctionne. Les modules personnels seront activés progressivement avec des règles de validation pour les actions sensibles.</p>
      <div class="grid">
        ...
        <div class="module"><strong>🎙️ Voix</strong><span class="soon">À connecter</span></div>
